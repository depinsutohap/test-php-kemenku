...
<form method="POST">
  ...
  <div class="form-group">
    ...
    <input class="form-control"  name="nama_produk" value="<?=$nama_produk?>">
  </div>
  <div class="form-group">
    <label for="deskripsi">deskripsi</label>
    <input class="form-control"  name="deskripsi" value="<?=$deskripsi?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="stok">jumlah_stok</label>
    <input type="number" class="form-control"  name="stok" value="<?=$jumlah_stok?>">
  </div>
  <button type="submit" class="btn btn-primary">Submit</button>
  <button type="button" class="btn btn-secondary" onclick="deleteProduct(<?=$id?>)">Delete</button>
</form>
</section>
